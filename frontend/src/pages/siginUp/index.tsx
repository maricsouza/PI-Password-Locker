    ...
    <div className={style.container}>
      ...
      <ImageWithLogo largura="320px"/>
        ...
        <div className={style.btnCadastrar}>
          <Button text={"Cadastrar"} largura={"500px"}/>
          <div className={style.textEntrar}><text> Ja possui conta? <Link href={"../login"}  className={style.linkEntrar}> Entrar</Link></text></div>
        </div>     
      </div>
    </div>
  );
